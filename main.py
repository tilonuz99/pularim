...
💸Доход с рефералов 1 Уровня - 100%
💸Доход с рефералов 2 Уровня - 0%'''.format(referals, refs2nd, bot_info.username, user['user_id']),
...
💸Доход с рефералов 1 Уровня - 100%
💸Доход с рефералов 2 Уровня - 0%'''.format(user['referal'], referals, refs2nd, bot_info.username, user['user_id'], bot_info.username, user['user_id']),
                    'markup': messages.start['markup']
                }
                try:
...
💸Доход с рефералов 1 Уровня - 100%
💸Доход с рефералов 2 Уровня - 0%'''.format(
...
💸 Выведено всего: *{}*p
    ...
    if text == 'Другой способ':
        return send_message(message, {'text': 'Если вы хотите пополнить баланс другим способом - напишите [администратору](tg://user?id=55555)', 'markup': messages.start['markup']}, parse_mode="Markdown")
    if text == '🔖 Мои заказы':
